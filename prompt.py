# prompt value va adjust panuro...so we get the desire output..
...
#edu vaandu direct ah public hub la irudu call pananum
...
def poem_generator_prompt_from_hub():
    ...
    """
    prompt_template = hub.pull("vethika-poem-generator/poem_generator")
    return prompt_template
